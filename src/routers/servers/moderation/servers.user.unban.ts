...
export const userUnban = async (req: express.Request, res: express.Response) => {
    ...
    try {
        ...
        if (Server.banned_users == null) throw "Server does not have any banned users"
        ...
        Emitter.emit("updateUnban", Server)
