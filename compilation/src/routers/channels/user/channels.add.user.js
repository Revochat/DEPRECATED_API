...
const join = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!utils_1.default.FUNCTIONS.PERMISSIONS.checkChannelPermissions(User, Channel, utils_1.default.CONSTANTS.CHANNEL.PERMISSIONS.MEMBER.INVITE))
        ...
        logger_client_1.default.debug(`User ${UserToAdd} has been added to channel ${Channel}`);
