...
const inviteCreate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!server_id || !token || !uses || !expires_at ||
        ...
        token.length < utils_1.default.CONSTANTS.USER.TOKEN.MIN_LENGTH || token.length > utils_1.default.CONSTANTS.USER.TOKEN.MAX_LENGTH || expires_at instanceof Date || uses instanceof Number)
